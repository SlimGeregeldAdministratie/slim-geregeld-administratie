...
const TechLanding = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      hasFullReview: true,
      onReadMore: () => window.open('https://maps.app.goo.gl/cz2LpkpYzyJQTiyg6', '_blank')
    }
  ];
  ...
  const packages = [
    {
      name: "Alleen Slim",
      description: "Perfect voor techniek & ICT ondernemers die zelf hun administratie doen",
      ...
      features: [
        ...
        "24/7 vragen beantwoorden over tech kosten",
        "Klanten beheer",
        "Software licenties herkenning"
      ],
    ...
    },
    {
      ...
      description: "Voor techniek & ICT ondernemers die alles uit handen willen geven",
      branchBenefit: "Ideaal voor ondernemers die hun tijd willen besteden aan innoveren, niet op administratie",
      originalPrice: "€125",
      price: "€95",
      period: "/maand",
      trialText: "30 dagen gratis",
      ...
      features: [
        ...
        "Klanten beheer",
        "BTW-aangifte voor tech sector",
        "Jaarrekening",
        "Persoonlijk contact met Kyle",
        "Tech aftrekposten optimalisatie"
      ],
      buttonText: "Start gratis proef",
      buttonStyle: "bg-blue-600 hover:bg-blue-700 text-white",
      cardStyle: "bg-white border-2 border-indigo-600 hover:shadow-xl"
    },
    {
      name: "Maatwerk",
      description: "Voor BV's en grotere techniek & ICT bedrijven",
      branchBenefit: "Aangepaste service voor bedrijven met complexe projecten en meerdere entiteiten",
      price: "Op maat",
      period: "",
      ...
      features: [
        ...
        "Aangepaste service voor tech sector",
        "Complexe projectadministraties",
        "Meerdere entiteiten",
        "Strategisch advies voor groei",
        "Freelancer netwerk administratie"
      ],
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:pr-8">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Als developer, IT-consultant of tech professional wil je je tijd besteden aan innoveren en ontwikkelen, niet aan administratie. 
                Wij regelen je boekhouding, zodat jij kunt focussen op wat je het beste kunt: technologie ontwikkelen.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Waarom kiezen developers en IT-consultants voor Slim Geregeld Administratie?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We begrijpen de uitdagingen van ondernemers. Daarom hebben we onze service 
              afgestemd op jouw behoeften als developer, IT-consultant of tech specialist.
            </p>
          </div>
            ...
            {packages.map((pkg, index) => (
              <div key={index} className={`rounded-2xl p-8 transition-all duration-200 relative ${pkg.cardStyle} ${pkg.popular ? 'transform scale-105' : ''}`}>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-blue-600 text-xs mt-2 font-medium italic">
                    {pkg.branchBenefit}
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Focus op code, niet op kosten</h2>
              <p className="text-gray-600 mb-8">
                Vertel ons over je tech projecten en ontdek hoe we je kunnen helpen om meer tijd over te houden voor ontwikkelen. 
                Geen gedoe met software licenties aftrekken, gewoon programmeren.
              </p>
