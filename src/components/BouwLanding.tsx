...
const BouwLanding = () => {
  ...
  const packages = [
    {
      name: "Alleen Slim",
      description: "Perfect voor bouw & installatie ondernemers die zelf hun administratie doen",
      ...
      features: [
        ...
        "24/7 vragen beantwoorden over bouw & installatie kosten",
        "Klanten beheer",
        "Materiaal- en installatiekosten herkenning"
      ],
    ...
    },
    {
      ...
      description: "Voor bouw & installatie ondernemers die alles uit handen willen geven",
      branchBenefit: "Ideaal voor ondernemers die zich willen focussen op projecten, niet op administratie",
      originalPrice: "€125",
      price: "€95",
      period: "/maand",
      trialText: "30 dagen gratis",
      ...
      features: [
        ...
        "Klanten beheer",
        "BTW-aangifte voor bouw & installatie",
        "Jaarrekening",
        "Persoonlijk contact met Kyle",
        "Bouw & installatie aftrekposten optimalisatie"
      ],
      buttonText: "Start gratis proef",
    ...
    {
      name: "Maatwerk",
      description: "Voor BV's en grotere bouw & installatie bedrijven",
      ...
      features: [
        ...
        "Aangepaste service voor bouw & installatie",
        "Complexe projectadministraties",
        "Meerdere entiteiten",
        "Strategisch advies voor groei",
        "Onderaannemers en installateurs administratie"
      ],
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:pr-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 leading-tight">
                ...
                <span className="text-orange-600">boekhouding</span>
              </h1>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Als aannemer, elektricien of schilder heb je geen tijd voor ingewikkelde administratie. Wij regelen je boekhouding, 
                zodat jij kunt focussen op wat je het beste kunt: bouwen, installeren en vakwerk leveren.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Waarom kiezen aannemers en elektriciens voor Slim Geregeld Administratie?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We begrijpen de uitdagingen van ondernemers. Daarom hebben we onze service 
              afgestemd op jouw behoeften als aannemer of installateur.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col">
              ...
              <p className="text-gray-600 mb-8">
                Vertel ons over je projecten en ontdek hoe we je kunnen helpen om meer tijd over te houden voor het echte werk. Geen gedoe met BTW-aangiftes, gewoon klussen.
              </p>
