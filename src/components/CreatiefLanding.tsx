...
const CreatiefLanding = () => {
  ...
  const packages = [
    {
      name: "Alleen Slim",
      description: "Perfect voor creatieve freelancers die zelf hun administratie doen",
      branchBenefit: "Voor creatievelingen die hun administratie zelf willen regelen, volledig via WhatsApp",
      price: "€75",
      period: "/maand",
      ...
      features: [
        ...
        "24/7 vragen beantwoorden over creatieve kosten",
        "Klanten beheer",
        "Projectkosten herkenning"
      ],
    ...
    },
    {
      ...
      description: "Voor alle creatieve professionals die alles uit handen willen geven",
      branchBenefit: "Ideaal voor creatievelingen die hun tijd willen besteden aan projecten, niet aan administratie",
      originalPrice: "€125",
      price: "€95",
      period: "/maand",
      trialText: "30 dagen gratis",
      ...
      features: [
        ...
        "Klanten beheer",
        "BTW-aangifte voor creatieve sector",
        "Jaarrekening",
        "Persoonlijk contact met Kyle",
        "Creatieve aftrekposten optimalisatie"
      ],
      buttonText: "Start gratis proef",
      buttonStyle: "bg-blue-600 hover:bg-blue-700 text-white",
      cardStyle: "bg-white border-2 border-purple-600 hover:shadow-xl"
    },
    {
      name: "Maatwerk",
      description: "Voor BV's en grotere creatieve bureaus",
      branchBenefit: "Aangepaste service voor creatieve bureaus met meerdere freelancers en complexe projecten",
      price: "Op maat",
      period: "",
      ...
      features: [
        ...
        "Aangepaste service voor creatieve sector",
        "Complexe projectadministraties",
        "Meerdere entiteiten",
        "Strategisch advies voor groei",
        "Freelancer administratie"
      ],
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:pr-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 leading-tight">
                ...
                <span className="text-purple-600">boekhouding</span>
              </h1>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Als fotograaf, videomaker of designer heb je geen tijd voor ingewikkelde administratie. Wij regelen je boekhouding, 
                zodat jij kunt focussen op wat je het beste kunt: creatieve projecten realiseren.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Waarom kiezen fotografen en ontwerpers voor Slim Geregeld Administratie?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We begrijpen de uitdagingen van ondernemers. Daarom hebben we onze service 
              afgestemd op jouw behoeften als fotograaf, designer of videomaker.
            </p>
          </div>
            ...
            {packages.map((pkg, index) => (
              <div key={index} className={`rounded-2xl p-8 transition-all duration-200 relative ${pkg.cardStyle} ${pkg.popular ? 'transform scale-105' : ''}`}>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-purple-600 text-xs mt-2 font-medium italic">
                    {pkg.branchBenefit}
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Wil je geen stress meer voor je btw-deadline?</h2>
              <p className="text-gray-600 mb-8">
                Vertel ons over je creatieve projecten en ontdek hoe we je kunnen helpen om meer tijd over te houden voor je passie. 
                Geen gedoe met bonnetjes, gewoon ondernemen.
              </p>
...
export default CreatiefLanding;