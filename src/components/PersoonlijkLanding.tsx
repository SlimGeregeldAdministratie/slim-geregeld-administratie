...
const PersoonlijkLanding = () => {
  ...
  const testimonials = [
    {
      ...
      hasFullReview: true,
      onReadMore: () => window.open('https://maps.app.goo.gl/gQpY9LhWrDCwau2v7', '_blank')
    },
    {
      ...
      hasFullReview: true,
      onReadMore: () => window.open('https://maps.app.goo.gl/HZJpLdfC8V7X1DwN7', '_blank')
    }
  ];
  ...
  const packages = [
    {
      name: "Alleen Slim",
      description: "Perfect voor persoonlijke dienstverleners die zelf hun administratie doen",
      ...
      features: [
        ...
        "24/7 vragen beantwoorden over dienstverlening kosten",
        "Klanten beheer",
        "Cursus- en opleidingskosten herkenning"
      ],
    ...
    },
    {
      ...
      description: "Voor persoonlijke dienstverleners die alles uit handen willen geven",
      branchBenefit: "Ideaal voor ondernemers die zich willen focussen op hun klanten, niet op administratie",
      originalPrice: "€125",
      price: "€95",
      period: "/maand",
      trialText: "30 dagen gratis",
      ...
      features: [
        ...
        "Klanten beheer",
        "BTW-aangifte voor dienstverlening",
        "Jaarrekening",
        "Persoonlijk contact met Kyle",
        "Dienstverlening aftrekposten optimalisatie"
      ],
      buttonText: "Start gratis proef",
      buttonStyle: "bg-blue-600 hover:bg-blue-700 text-white",
      cardStyle: "bg-white border-2 border-green-600 hover:shadow-xl"
    },
    {
      name: "Maatwerk",
      description: "Voor BV's en grotere persoonlijke dienstverlening bedrijven",
      branchBenefit: "Aangepaste service voor bedrijven met complexe klantadministraties en meerdere entiteiten",
      price: "Op maat",
      period: "",
      ...
      features: [
        ...
        "Aangepaste service voor dienstverlening",
        "Complexe klantadministraties",
        "Meerdere entiteiten",
        "Strategisch advies voor groei",
        "Multi-locatie administratie"
      ],
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:pr-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 leading-tight">
                ...
                <span className="text-green-600">boekhouding</span>
              </h1>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Als coach, kapper of trainer wil je je tijd besteden aan het helpen van klanten, niet aan administratie. 
                Wij regelen je boekhouding, zodat jij kunt focussen op wat je het beste kunt: klanten helpen en groeien.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Waarom kiezen coaches en kappers voor Slim Geregeld Administratie?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We begrijpen de uitdagingen van ondernemers. Daarom hebben we onze service 
              afgestemd op jouw behoeften als coach, kapper of personal trainer.
            </p>
          </div>
            ...
            {packages.map((pkg, index) => (
              <div key={index} className={`rounded-2xl p-8 transition-all duration-200 relative ${pkg.cardStyle} ${pkg.popular ? 'transform scale-105' : ''}`}>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-green-600 text-xs mt-2 font-medium italic">
                    {pkg.branchBenefit}
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Binnen 24 uur inzicht in je boekhouding, zonder gedoe</h2>
              <p className="text-gray-600 mb-8">
                Vertel ons over je praktijk en ontdek hoe we je kunnen helpen om meer tijd over te houden voor je klanten. 
                Geen gedoe met BTW, gewoon helpen.
              </p>
...
export default PersoonlijkLanding;